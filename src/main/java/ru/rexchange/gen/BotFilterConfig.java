...
public class BotFilterConfig {
  public static final String TABLE_NAME = "BOT_FILTER_CONFIG";
  public static final String FIELD_ID = "ID";
  public static final String FIELD_TYPE = "TYPE";
  public static final String FIELD_BOT_ID = "BOT_ID";
  private static final String QUERY_LOAD_OBJECT = "SELECT ID, TYPE, BOT_ID FROM BOT_FILTER_CONFIG WHERE ID = ?";
  private static final String QUERY_INSERT_OBJECT = "INSERT INTO BOT_FILTER_CONFIG(ID, TYPE, BOT_ID) VALUES (?, ?, ?)";
  private static final String QUERY_UPDATE_OBJECT = "UPDATE BOT_FILTER_CONFIG SET TYPE = ?, BOT_ID = ? WHERE ID = ?";
  private static final String QUERY_ID_SEQ_VALUE = "SELECT gen_id(SEQ_BOT_FILTER_CONFIG_ID, 1) FROM rdb$database";
  ...
  public BotFilterConfig() {
  }

  public BotFilterConfig(Long id) {
    this.id = id;
  }

  public static BotFilterConfig createAndLoad(Connection conn, Long id) throws SQLException, UserException, SystemException {
    BotFilterConfig instance = new BotFilterConfig();
    instance.id = id;
    instance.load(conn);
    return instance;
  }
  ...
  public void load(Connection conn) throws SQLException, UserException, SystemException {
    ...
    if (result != null) {
      BotFilterConfig.fillFromResultSet(result, this);
      isNew = false;
    } else {
  ...
  public static void fillFromResultSet(Map<String, Object> result, BotFilterConfig obj) {
